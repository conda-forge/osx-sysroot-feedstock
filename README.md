About macosx_deployment_target_osx-64-feedstock
===============================================
...
Installing macosx_deployment_target_osx-64
==========================================

Installing `macosx_deployment_target_osx-64` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating macosx_deployment_target_osx-64-feedstock
==================================================

If you would like to improve the macosx_deployment_target_osx-64 recipe or build a new
...
Note that all branches in the conda-forge/macosx_deployment_target_osx-64-feedstock are
